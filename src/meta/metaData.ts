...
export const metaData: { [key: string]: MetaData_I } = {
  app: {
    ...
    image: images.Home,
    url: "https://code-catcher-fe.azurewebsites.net/",
  },
  splash: {
    title: "온보딩 | 코디 Codee",
    description:
  ...
  myPage: {
    ...
    image: images.MyPage,
    url: "https://code-catcher-fe.azurewebsites.net/myPage",
  },
};
