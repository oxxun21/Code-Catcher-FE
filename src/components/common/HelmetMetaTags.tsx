...
export const HelmetMetaTags = ({ meta }: HelmetMetaTagsProps) => {
  return (
    <Helmet>
      ...
      <meta property="og:image" content="https://likelion-codee.com/assets/meta/metaCover.png" />
      ...
      <meta name="twitter:image" content="https://likelion-codee.com/assets/meta/metaCover.png" />
    </Helmet>
  );
};
